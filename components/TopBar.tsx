    ...
    <div ref={ref} style={{ position: "relative", flexShrink: 0 }}>
      <button onClick={() => setOpen((v) => !v)} style={{
        ...
        {running > 0
          ...
          : <svg width="10" height="10" viewBox="0 0 14 14" fill="none"><polyline points="2,7 5.5,10.5 12,3.5" stroke="#4ade80" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" /></svg>
        }
        {notifs.length}
      </button>
      {open && (
        <div style={{
          position: "absolute", top: "calc(100% + 6px)", right: 0, width: 260, zIndex: 200,
          backgroundColor: "var(--bg-surface)", border: "1px solid var(--border)",
          borderRadius: 12, boxShadow: "0 8px 32px rgba(0,0,0,0.35)", overflow: "hidden",
        }}>
...
export default function TopBar() {
  ...
  return (
    <nav style={{
      position: "fixed", top: 0, left: 0, right: 0, height: 52, zIndex: 41,
